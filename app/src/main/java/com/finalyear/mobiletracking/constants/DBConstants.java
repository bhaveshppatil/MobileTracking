...
public class DBConstants {
    ...
    //CREATE TABLE
    public static final String CREATE_TB = "CREATE TABLE tbl_location_updates(id INTEGER PRIMARY KEY AUTOINCREMENT," + "userName TEXT NOT NULL,emailId TEXT NOT NULL,mobNumber TEXT NOT NULL,imeiNumber TEXT NOT NULL,androidOs TEXT NOT NULL,deviceName TEXT NOT NULL,longitude TEXT NOT NULL,latitude TEXT NOT NULL,location TEXT NOT NULL,date TEXT NOT NULL,time TEXT NOT NULL);";
